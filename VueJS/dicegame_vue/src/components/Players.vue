<template>
  <div class="wrapper-layer">
    <div class="player-panel" v-bind:class="{ active : this.activePlayer == 0 && !this.isWinner , winner: activePlayer == 0 && this.isWinner }">
    ...
    <div class="player-panel" v-bind:class="{ active : this.activePlayer == 1 && !this.isWinner , winner: activePlayer == 1 && this.isWinner}">
